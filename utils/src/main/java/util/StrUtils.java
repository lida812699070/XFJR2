...
//	}
	...
	public static String formatMoney(String money) {
		double m = NumberUtils.parseDouble(money);
		if (m < 1)
			m = 1;
		if (m >= 10000) {
			return formatAmountClearZero(m / 10000) + "万";
		}
		return formatAmountClearZero(m) + "元";
	}
	 ...
	 * @return
	 */
	public static String formatMoney(String money, TextView textView) {
		double m = NumberUtils.parseDouble(money);
		if (m < 1)
			m = 1;
		if (m >= 10000) {
			textView.setText("万");
			return formatAmountClearZero(m / 10000);
		}
		textView.setText("元");
		return formatAmountClearZero(m);
	}
