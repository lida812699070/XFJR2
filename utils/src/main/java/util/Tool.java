...
import com.wang.asus.templete.R;
...
public class Tool {
     ...
     * @return
     */
    public static String disBankCard(String str){
        String targetstr = "";
        if (str == null || "".equals(str))
            return "";
        int len = str.length();
        ...
        // 尾部8个数字
        sb.append(str.substring(len - 8, len-4));
        sb.append(" ");
     ...
     * @return
     */
    public static String disName(String str) {
     ...
     * @param string
     */
    public void SysCopy(Context context, String string) {
        ClipboardManager c = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
        c.setPrimaryClip(ClipData.newPlainText(context.getResources().getString(R.string.app_name), string));    //设置Clipboard 的内容
    }
